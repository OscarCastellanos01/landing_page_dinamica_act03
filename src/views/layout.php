                ...
                <div class="col-md-4">
                    <div class="text-center">
                        ...
                        <p 
                            class="text-muted"
                        >
                            Enterprise-grade security to protect your data and privacy at all times.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="text-center">
                        ...
                        <p 
                            class="text-muted"
                        >
                            Lightning-fast speeds ensure your work flows smoothly without interruption.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <h2 class="card-price">$9<small class="text-muted">/mo</small></h2>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-primary">
                        <div class="card-body">
                            ...
                            <h2 class="card-price">$29<small class="text-muted">/mo</small></h2>
                            <ul class="list-unstyled mt-4">
                                <li class="mb-2">
                                    <i class="bi bi-check-circle text-primary me-2"></i>
                                    All Basic features
                                </li>
                                <li class="mb-2"><i class="bi bi-check-circle text-primary me-2"></i>
                                    Up to 20 users
                                </li>
                                <li class="mb-2">
                                    <i class="bi bi-check-circle text-primary me-2"></i>
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <h2 class="card-price">$99<small class="text-muted">/mo</small></h2>
                            <ul class="list-unstyled mt-4">
                                <li class="mb-2">
                                    <i class="bi bi-check-circle text-primary me-2"></i>
                                    All Pro features
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p 
                                class="card-text"
                            >
                                "FakeProduct ha transformado nuestra forma de trabajar. Las mejoras en eficiencia son notables."
                            </p>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p 
                                class="card-text"
                            >
                                "La mejor inversión que hemos hecho para nuestro equipo. El soporte es excepcional."
                            </p>
                            <h5 class="card-title mb-1">María García</h5>
                            <p 
                                class="text-muted"
                            >
                                CTO, Empresa 2
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p 
                                class="card-text"
                            >
                                "Increíblemente fácil de usar. Ha mejorado nuestra productividad en un 200%."
                            </p>
